...
sr.reveal('.textbox1, .textbox3, .textbox5, .imagebox2, .imagebox4', {origin: 'right'})
sr.reveal('.textbox2, .textbox4, .imagebox1, .imagebox3, .imagebox5', {origin: 'left'})
